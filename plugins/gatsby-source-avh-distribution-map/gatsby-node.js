...
exports.onCreateNode = async (onCreateNode) => {
    if (onCreateNode.node.internal.owner === 'gatsby-source-contentful' && onCreateNode.node.internal.type === 'ContentfulPlantProfile' && !onCreateNode.node.doNotIncludeStaticMap) { //If node is contentful plant profile and needs static map
